    ...
    <div className="grid grid-cols-5 gap-2 px-2 mt-1">
      <div>
        <img
          ...
          alt=""
        />
        <p className="mt-2 font-semibold text-gray-700 dark:text-gray-400">Broad Checks Medium Grey Wool</p>
      ...
      <div>
        <img
          ...
          alt=""
        />
        <p className="mt-2 font-semibold text-gray-700 dark:text-gray-400">Brown Design Wool Rich Stripes</p>
        <p className="text-gray-400">From Rs.8,100PKR</p>
      </div>
      ...
      <div>
        <img
          ...
          alt=""
        />
        <p className="mt-2 font-semibold text-gray-700 dark:text-gray-400">Brown Self Stripes Wool Rich</p>
        <p className="text-gray-400">From Rs.8,100PKR</p>
      </div>
      ...
      <div>
        <img
          ...
          alt=""
        />
        <p className="mt-2 font-semibold text-gray-700 dark:text-gray-400">Cherry Red Houndstooth Wool Rich</p>
        <p className="text-gray-400">From Rs.8,100PKR</p>
      </div>
      ...
      <div>
        <img
          ...
          alt=""
        />
        <p className="mt-2 font-semibold text-gray-700 dark:text-gray-400">Dark Brown Plain Wool Rich</p>
        <p className="text-gray-400">From Rs.8,100PKR</p>
      </div>
    </div>
